...
export default function CompletedTaskManagePage() {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [allTasks, summaryRes] = await Promise.all([
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-4 gap-4">
            <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-green-500 flex items-center justify-center flex-shrink-0"><CheckCircle2 className="w-5 h-5 text-white" /></div><div><p className="text-xs text-muted-foreground">완료 과제 수</p><p className="text-xl font-bold tabular-nums">{completedSummary.totalCompleted}<span className="text-sm font-normal ml-0.5">건</span></p></div></div></CardContent></Card>
            <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-blue-500 flex items-center justify-center flex-shrink-0"><DollarSign className="w-5 h-5 text-white" /></div><div><p className="text-xs text-muted-foreground">목표 절감액</p><p className="text-xl font-bold tabular-nums">{formatAmount(completedSummary.totalSavingTarget)}</p></div></div></CardContent></Card>
            <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-emerald-500 flex items-center justify-center flex-shrink-0"><TrendingUp className="w-5 h-5 text-white" /></div><div><p className="text-xs text-muted-foreground">실제 절감액</p><p className="text-xl font-bold tabular-nums text-green-600">{formatAmount(completedSummary.totalActualSaving)}</p></div></div></CardContent></Card>
            <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-orange-500 flex items-center justify-center flex-shrink-0"><Award className="w-5 h-5 text-white" /></div><div><p className="text-xs text-muted-foreground">목표 달성율</p><p className="text-xl font-bold tabular-nums">{completedSummary.achievementRate}<span className="text-sm font-normal ml-0.5">%</span></p></div></div></CardContent></Card>
          </div>
